...
lazy val core = crossProject(JSPlatform, JVMPlatform)
  ...
  .settings(moduleName := "adversaria")
...
lazy val tests = project
  ...
  .settings(moduleName := "adversaria-tests")
  .dependsOn(coreJVM)
...
lazy val buildSettings = Seq(
  ...
  scmInfo := Some(
    ScmInfo(url("https://github.com/propensive/adversaria"),
            "scm:git:git@github.com:propensive/adversaria.git")
  )
)

lazy val publishSettings = Seq(
  homepage := Some(url("http://gitub.com/propensive/adversaria/")),
  ...
  pomExtra := (
    <developers>
      <developer>
        ...
        <url>https://github.com/propensive/adversaria/</url>
      </developer>
    </developers>
  ),
